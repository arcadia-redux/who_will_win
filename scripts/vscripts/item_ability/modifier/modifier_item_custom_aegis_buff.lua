modifier_item_custom_aegis_buff = class({})

function modifier_item_custom_aegis_buff:IsDebuff()
	return false
end
function modifier_item_custom_aegis_buff:GetTexture()
	return "omniknight_repel"
end

function modifier_item_custom_aegis_buff:OnCreated(table)
...
function modifier_item_custom_aegis_buff:DeclareFunctions()
  local funcs = 
  {
...
function modifier_item_custom_aegis_buff:GetModifierIncomingDamage_Percentage()
     return -65
end

function modifier_item_custom_aegis_buff:GetModifierTotalDamageOutgoing_Percentage()
     return 100
end